...
public class TrackService {
    ...
    public Track createTrack(String title, String artist, String album, Duration duration, LocalDate date) {
    ...
    public List<Track> getTracksWithFlexiSearch(SearchWrapper searchWrapper) {
